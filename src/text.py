class Text:
    ...
    choose_title_upload = "Впишите заголовок и нужный текст разделив их с помощью (~)\nЕсли длина вашего заголовка будет превышать 100 символов, он будет автоматически удален и не будет использован."
    ...
    log_deleted_length = "Title NON USED in DB due to its length: {title}. UserID/Name - {userid}/{username}"